    ...
    <div className="flex flex-col h-full">
      ...
      <div className="panel-header">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            <History className="w-3.5 h-3.5 panel-icon" />
          ...
          <div className="flex items-center gap-1.5">
            <div className="flex gap-1">
              <button
                ...
                className={`px-2 py-1 rounded-md text-[9px] font-semibold transition-all ${
                  activeTab === 'completed'
                    ? 'bg-white/[0.10] text-white/80 border border-white/[0.14] shadow-sm'
            ...
            <button
              ...
              className="p-1 rounded-md hover:bg-white/[0.06] transition-colors text-white/20 hover:text-white/40"
              title="Minimize"
            >
