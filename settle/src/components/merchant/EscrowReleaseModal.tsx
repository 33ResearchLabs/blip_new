      ...
      {showReleaseModal && releaseOrder && (
        <>
          ...
          <motion.div
            ...
            className="fixed z-50 w-full max-w-lg inset-x-0 bottom-0 mx-auto md:inset-auto md:bottom-auto md:top-1/2 md:left-1/2 md:-translate-x-1/2 md:-translate-y-1/2"
          >
            <div
