                  ...
                  >
                    <div className="flex items-center gap-2">
                      ...
                      <div className="flex-1 min-w-0">
                        <p className={`text-[11px] leading-tight ${hasUnread ? 'text-white/80 font-medium' : 'text-white/50'}`}>
                          {notif.message}
                        </p>
                        <span className="text-[9px] text-white/25 font-mono">{relTime}</span>
                      </div>
                      {group.count > 1 && (
                        <span className="text-[9px] font-mono text-white/30 bg-white/[0.06] px-1.5 py-0.5 rounded-full flex-shrink-0">
                          x{group.count}
                        </span>
                      )}
                      {hasUnread && (
