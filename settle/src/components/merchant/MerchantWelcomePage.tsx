...
export function MerchantWelcomePage({ onGetStarted, onSignIn }: MerchantWelcomePageProps) {
  ...
  return (
    <div className="merchant-welcome min-h-screen bg-[var(--mw-bg-[#f5f5f7])] text-[var(--mw-text-[#f5f5f7])] overflow-x-hidden">
      {/* Ambient glow */}
      ...
      {/* Nav */}
      <nav className="fixed top-0 w-full z-50 bg-[var(--mw-bg-[#f5f5f7])]/80 backdrop-blur-xl border-b border-[var(--mw-divider)]">
        <div className="max-w-6xl mx-auto px-6 h-14 flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            <Zap className="w-6 h-6 text-[var(--mw-text-[#f5f5f7])] fill-[var(--mw-text-[#f5f5f7])]" />
            <span className="text-lg leading-none">
              <span className="font-bold text-[var(--mw-text-[#f5f5f7])]">Blip</span>{" "}
          ...
          <div className="flex items-center gap-3">
            <button
              onClick={onSignIn}
              className="text-sm text-[var(--mw-text-tertiary)] hover:text-[var(--mw-text-[#f5f5f7])] transition-colors"
            >
              Sign In
            </button>
            <button
      ...
      <main className="relative pt-14">
        ...
        <section className="mw-hero-bg px-6 pt-16 pb-16 max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.4fr] gap-10 lg:gap-8 items-center">
            ...
            >
              ...
              <motion.h1
                variants={fadeUp}
                className="text-4xl sm:text-5xl md:text-[3.5rem] font-extrabold text-[var(--mw-text-[#f5f5f7])] leading-[1.1] tracking-tight mb-5"
              >
                Own the Flow
                <br />
                of Money
            ...
            >
              ...
              <div className="relative" style={{ perspective: '1200px' }}>
                ...
                >
                  ...
                  {/* ── Navbar ── */}
                  <div className="flex items-center justify-between px-3 py-1.5 bg-[var(--mw-bg-[#f5f5f7])] border-b border-[var(--mw-divider)]">
                    <div className="flex items-center gap-1.5">
                      <Zap className="w-3.5 h-3.5 text-[var(--mw-text-[#f5f5f7])] fill-[var(--mw-text-[#f5f5f7])]" />
                  ...
                  <div className="flex" style={{ height: 420 }}>
                    ...
                    <div className="w-[145px] border-r border-[var(--mw-divider)] flex flex-col overflow-hidden">
                      ...
                      <div className="px-2.5 py-2 border-b border-[var(--mw-divider)]">
                        ...
                        <p className="text-lg font-black text-[var(--mw-text-[#f5f5f7])] font-mono leading-none">5,150</p>
                      ...
                      <div className="px-2 py-1.5 border-b border-[var(--mw-divider)]">
                        ...
                        <p className="text-sm font-bold text-[var(--mw-text-[#f5f5f7])] font-mono text-center">92.15</p>
                      ...
                      <div className="px-2 py-1.5 border-b border-[var(--mw-divider)]">
                        ...
                        <div className="flex items-baseline gap-0.5">
                          <span className="text-sm font-bold text-[var(--mw-text-[#f5f5f7])] font-mono">196</span>
                  ...
                  {/* Bottom status bar */}
                  <div className="flex items-center justify-between px-3 py-1 bg-[var(--mw-bg-[#f5f5f7])] border-t border-[var(--mw-divider)]">
                    <div className="flex items-center gap-1.5">
          ...
          >
            {stats.map((s, i) => (
              <div key={i} className="text-center">
                <div className="text-xl sm:text-2xl font-bold text-[var(--mw-text-[#f5f5f7])] mb-1 font-mono">
                  {s.value}
                </div>
        ...
        <section className="px-6 py-20 max-w-5xl mx-auto">
          ...
          >
            <h2 className="text-2xl sm:text-3xl font-bold text-[var(--mw-text-[#f5f5f7])] mb-3">
              How It Works
            </h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {steps.map((step, i) => (
              ...
              >
                ...
                <h4 className="text-sm font-bold text-[var(--mw-text-[#f5f5f7])] mb-1.5">
                  {step.title}
                </h4>
        ...
        <section className="px-6 py-20 max-w-5xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            >
              ...
              <h3 className="text-2xl sm:text-3xl font-bold text-[var(--mw-text-[#f5f5f7])] mb-3 leading-tight">
            ...
            >
              ...
              <h4 className="text-lg font-bold text-[var(--mw-text-[#f5f5f7])] mb-2">
                KYB Verified
              </h4>
        ...
        <section className="px-6 py-20 max-w-4xl mx-auto">
          ...
          >
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold text-[var(--mw-text-[#f5f5f7])] mb-4 relative z-10">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 relative z-10">
              <button
                onClick={onGetStarted}
                className="w-full sm:w-auto px-10 py-4 bg-[var(--mw-text-[#f5f5f7])] text-[var(--mw-bg-[#f5f5f7])] rounded-2xl font-bold text-sm hover:opacity-90 transition-all"
              >
      ...
      <footer className="border-t border-[var(--mw-divider)] py-10">
        <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="flex items-center gap-2">
            <Zap className="w-5 h-5 text-[var(--mw-text-[#f5f5f7])] fill-[var(--mw-text-[#f5f5f7])]" />
            <span className="text-sm font-bold text-[var(--mw-text-[#f5f5f7])]">
