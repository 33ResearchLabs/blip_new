...
export function FilterDropdown<T extends string>({
  ...
  const triggerClass =
    variant === "square"
      ...
      : "flex items-center gap-1.5 px-1.5 py-1 rounded-full transition-all bg-surface-active text-text-primary border border-border-medium text-[9px] font-bold tracking-[0.05em]";
