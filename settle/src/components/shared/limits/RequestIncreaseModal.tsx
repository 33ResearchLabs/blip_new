          ...
          >
            ...
            <div className="flex gap-3 mt-3">
              ...
              <button
                onClick={submit}
                disabled={submitting}
                className="flex-1 px-4 py-3 rounded-xl bg-text-primary text-background text-[13px] font-bold hover:opacity-90 transition-opacity disabled:opacity-50 inline-flex items-center justify-center gap-2"
              >
