...
import {
  ChevronLeft, MessageCircle, ArrowUpRight, AlertTriangle,
} from "lucide-react";
...
interface ChatViewScreenProps {
  ...
  sendChatMessage: (orderId: string, message: string) => void;
  chatMessagesRef: React.RefObject<HTMLDivElement | null>;
}

export function ChatViewScreen({
  maxW, setScreen, activeOrder, activeChat,
  chatMessage, setChatMessage, sendChatMessage, chatMessagesRef,
}: ChatViewScreenProps) {
  return (
          <motion.div
            key="chat-view"
