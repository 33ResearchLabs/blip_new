...
export interface OrderScreenProps {
  ...
  setEscrowTxStatus: (v: EscrowTxStatus) => void;
          ...
          <>
            ...
            >
              ...
              >
                ...
                {disputeInfo?.status === 'pending_confirmation' && disputeInfo.proposed_resolution && !activeChat?.messages.some((m: any) => m.messageType === 'resolution') && (
