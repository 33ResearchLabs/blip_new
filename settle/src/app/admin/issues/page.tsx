 ...
 * view). Panel content lives in `IssuesPanel` so it can be re-hosted
 * under the merged `/admin/observability` tabbed page without
 * duplication. Polls every 15s.
 */
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="max-w-7xl mx-auto px-4 py-4">
        <IssuesPanel onRefreshStateChange={setRefreshState} />
      </main>
    </div>
  );
}
