 ...
 */
export function normalizeStatus(dbStatus) {
    const mapping = {
        pending: 'open',
        accepted: 'accepted',
 ...
 */
export function expandStatus(minimalStatus) {
    const expansion = {
        open: ['pending'],
 ...
 */
export function denormalizeStatus(minimalStatus) {
    const mapping = {
        open: 'pending',
        accepted: 'accepted',
        escrowed: 'escrowed',
 ...
 */
export function isTransientStatus(dbStatus) {
 ...
 */
export function validateStatusWrite(status) {
    if (isTransientStatus(status)) {
        throw new Error(`Cannot write transient status '${status}'. Use minimal status instead: ${normalizeStatus(status)}`);
    }
}
/**
 ...
 */
export function getCanonicalStatus(minimalStatus) {
 ...
 */
export function getMinimalStatusDisplay(status) {
    const displayNames = {
        open: 'Open',
        accepted: 'Accepted',
        escrowed: 'Escrowed',
 ...
 */
export function getMinimalStatusEmoji(status) {
    const emojis = {
        open: '📋',
        accepted: '✓',
        escrowed: '🔒',
